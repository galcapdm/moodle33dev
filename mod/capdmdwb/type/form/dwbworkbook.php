...
class dwb_workbook_form extends dwb_workbook_type {
	...
	$wrappertable  = $CFG->prefix."capdmdwb_wrapper";
        ...
        $responsetable = $CFG->prefix."capdmdwb_response";
	...
	// First, get the template for the form
	$fn = "dundee_form.xml";
	if (!$xml_t = simplexml_load_file($fn)) {
	    echo("Can't load XML file ".$fn);  die;
	}
	...
	$doc->Image($CFG->dirroot.'/theme/'.current_theme().'/pix/logo.jpg', 8, 8, 'M');  // Theme logo
